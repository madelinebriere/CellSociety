...
/**
 * Cell used in the segregation simulation. Classified solely by color (state).
 * 
 * NOTE: This classification has caused problems because all other Cells are
 * defined by class type, and different colored HouseCells cannot be
...
public class HouseCell extends Cell {
	 ...
	 * 
	 * @param data
	 *            CellData object holding information for HouseCell use
	 * @return ArrayList of next generation Cells, either contains the current
	 *         Cell in the same location, or the current Cell in a new location
