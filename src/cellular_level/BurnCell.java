...
/**
 * Burning tree cell in the forest fire CA simulation Burns for a set number of
 * steps before dying
 * 
 * @author maddiebriere
 */
...
public class BurnCell extends Cell {
	...
	/**
	 * @param CellData
	 *            holding information about board and allowing access to Cell's
	 *            neighbors
	 * @return An ArrayList of Cells for the next generation of Cells. This
	 *         ArrayList will either hold a burnt cell or the same burning cell.
	 */
	@Override
