...
/**
 * Non-burning tree cell in the forest fire CA simulation Either remains healthy
 * with the update or changes into a burning cell (BurnCell)
 * 
 * @author maddiebriere
 */
...
public class TreeCell extends Cell {
	...
	/**
	 * @param data
	 *            CellData object holding info for Cell
	 * @return An ArrayList of Cells for the next generation of Cells. This
	 *         ArrayList will either contain the current Cell, if it does not
	 *         catch fire, or a new BurnCell in the same location (if the tree
	 *         has caught fire)
	 */
	@Override
