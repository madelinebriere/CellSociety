...
/**
 * Superclass to the Live and Dead Cells, holds common actions like copy
 * creation and general update
 * 
...
public abstract class LifeSimCell extends Cell {
	...
	/**
	 * @param data
	 *            CellData object holding accessible information for Cell
	 * @return ArrayList of Cells for the next generation. Will contain either
	 *         the current live cell or a new dead cell in the same location.
	 *         Never empty.
	 */
	@Override
