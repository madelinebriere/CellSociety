...
public class FireSimulation extends SimulationType {
	...
	private static final List<String> SETTING_TYPES = Arrays.asList(new String[] { "probability", "steps" });
	private static final List<String> DEFAULT_SETTINGS = Arrays.asList(new String[] {
			((Double) (TreeCell.PROB_CATCH)).toString(), ((Integer) (BurnCell.STEPS_TO_BURN)).toString() });
	private static final List<String> DEFAULT_CELLS = Arrays.asList(new String[] { ".95 tree", ".05 burn" });
